...
for ($i = 0; $i < 10000; $i++) {
    ...
    //single && sync
    $ret = $obj->singleAPI("/module_a/abc" . $i, array("mark" => 234, "foo" => $i), \DoraRPC\RpcConst::SW_MODE_WAITRESULT, 1);
...
//    var_dump("single async result", $ret);
    ...
    $ret = $obj->multiAPI($data, \DoraRPC\RpcConst::SW_MODE_WAITRESULT, 1);
...
//    var_dump("multi async", $ret);
    ...
    $ret = $obj->multiAPI($data, \DoraRPC\RpcConst::SW_MODE_ASYNCRESULT, 1);
